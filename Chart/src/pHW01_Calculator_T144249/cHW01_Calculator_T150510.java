 ...
 */
public class cHW01_Calculator_T150510 extends JFrame {
	JTextField txtIn = new JTextField(), txtIn00 = new JTextField();
	JPanel panbox = new JPanel(), panPr00 = new JPanel(), panPr01 = new JPanel();
	JRadioButton deg = new JRadioButton("Degrees"), rad = new JRadioButton("Radians"), gra = new JRadioButton("Grads"),
			hex = new JRadioButton("Hex"), dec = new JRadioButton("Dec"), oct = new JRadioButton("Oct"),
	...
	JMenu view = new JMenu("View"), edit = new JMenu("Edit"), help = new JMenu("Help");
	JMenuItem stand = new JMenuItem("Standard", KeyEvent.VK_D), scien = new JMenuItem("Scientific", KeyEvent.VK_S),
			programmer = new JMenuItem("Programmer", KeyEvent.VK_P), exit = new JMenuItem("Exit", KeyEvent.VK_X),
			copy = new JMenuItem("Copy", KeyEvent.VK_C), paste = new JMenuItem("Paste", KeyEvent.VK_V),
			about = new JMenuItem("About", KeyEvent.VK_A);
	ImageIcon imgcopy = new ImageIcon("Icon/Copy.gif"), imgpaste = new ImageIcon("Icon/Paste.gif");
	...
	public cHW01_Calculator_T150510() {
		...
		stand.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.ALT_MASK));
		scien.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK));
		programmer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.ALT_MASK));
	...
	String[][] sStard = { { "MC", "MR", "MS", "M+", "M-" }, { "<-", "CE", "C", "+/-", "sqrt" },
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		cHW01_Calculator_T150510 mainWindow = new cHW01_Calculator_T150510();
